...
TEST_CASE("Comprobando constructores y métodos get Asignatura", "[Constructores-Get-Asignatura]" ) {
    ...
    Asignatura * a1 = new Asignatura("Pepe",60,801,Tipo::Troncal);
    REQUIRE( a1->getNombre() == "Pepe" );
    REQUIRE( a1->getCreditos() == 60 );
    REQUIRE( a1->getPlanEstudios() == 801 );
    REQUIRE( a1->getTipo() == Tipo::Troncal );
}
...
TEST_CASE("Comprobando métodos setTipo y getTipo", "[Tipo-Asignatura]" ) {
    ...
    REQUIRE( a1->getTipo() == Tipo::Obligatoria );
    a1->setTipo(Tipo::Optativa);
    REQUIRE( a1->getTipo() == Tipo::Optativa );
}
...
TEST_CASE("Comprobando constructores y métodos get Matricula", "[Constructores-Get-Matricula]" ) {
    ...
    Asignatura * a1 = new Asignatura("POO",60,801,Tipo::Troncal);
    Estudiante * e1 = new Estudiante("peperez",true);



    Matricula * m = new Matricula(a1,e1,Curso::C2122,OrdenMatricula::M1,10);
    ...
    REQUIRE( m->getEstudiante()->getFamiliaNumerosa() == true);
    REQUIRE( m->getCurso() == Curso::C2122);
    REQUIRE( m->getOrdenMatricula() == OrdenMatricula::M1);
...
TEST_CASE("Familia no numerosa primera matricula", "[PrimeraMatriculaNoNumerosa]" ) {
    ...
    Matricula * m1 = new Matricula(act1, est1, Curso::C1920,OrdenMatricula::M1,20);
    Matricula * m2 = new Matricula(act2, est1, Curso::C2122,OrdenMatricula::M1,10);
...
TEST_CASE("Familia no numerosa segunda matricula", "[SegundaMatriculaNoNumerosa]" ) {
    ...
    Actividad * act2 = new Reconocimiento("Deportes", 2, "Campeonatos universitarios");
    Estudiante * est1 = new Estudiante("peperez",false);
    Matricula * m1 = new Matricula(act1, est1, Curso::C1920,OrdenMatricula::M2,20);
    Matricula * m2 = new Matricula(act2, est1, Curso::C2122,OrdenMatricula::M2,10);
...
TEST_CASE("Familia no numerosa tercera matricula", "[TerceraMatriculaNoNumerosa]" ) {
    ...
    Actividad * act2 = new Reconocimiento("Deportes", 2, "Campeonatos universitarios");
    Estudiante * est1 = new Estudiante("peperez",false);
    Matricula * m1 = new Matricula(act1, est1, Curso::C1920,OrdenMatricula::M3,20);
    Matricula  * m2 = new Matricula(act2, est1, Curso::C2122,OrdenMatricula::M3,10);
...
TEST_CASE("Familia no numerosa cuarta matricula", "[CuartaMatriculaNoNumerosa]" ) {
    ...
    Actividad * act2 = new Reconocimiento("Deportes", 2, "Campeonatos universitarios");
    Estudiante * est1 = new Estudiante("peperez",false);
    Matricula * m1 = new Matricula(act1, est1, Curso::C1920,OrdenMatricula::M4,20);
    Matricula * m2 = new Matricula(act2, est1, Curso::C2122,OrdenMatricula::M4,10);
...
TEST_CASE("Familia numerosa", "[Numerosa]" ) {
    Actividad * act1 = new Asignatura("POO", 6, 2010, Tipo::Troncal);
    Actividad * act2 = new Reconocimiento("Deportes", 2, "Campeonatos universitarios");
    Actividad *  act3 = new Asignatura("TP",6, 2010, Tipo::Obligatoria);
    Actividad  * act4 = new Reconocimiento("Deportes", 4, "Campeonatos universitarios");
    Estudiante  * est1 = new Estudiante("peperez",true);
    Matricula * m1 = new Matricula(act1, est1, Curso::C1920,OrdenMatricula::M1,20);
    Matricula * m2 = new Matricula(act2, est1, Curso::C2122,OrdenMatricula::M2,10);
    Matricula * m3 = new Matricula(act3, est1, Curso::C1920,OrdenMatricula::M3,20);
    Matricula * m4 = new Matricula(act4, est1, Curso::C2122,OrdenMatricula::M4,10);
