...
TEST_CASE("Comprobando constructores y métodos get Matricula", "[Constructores-Get-Matricula]" ) {
    ...
    Matricula * m = new Matricula(a1,e1,C2122,M1,10);
...
TEST_CASE("Familia no numerosa primera matricula", "[PrimeraMatriculaNoNumerosa]" ) {
		...
		Matricula * m1 = new Matricula(act1, est1, C1920,M1,20);
		Matricula * m2 = new Matricula(act2, est1, C2122,M1,10);
...
TEST_CASE("Familia no numerosa segunda matricula", "[SegundaMatriculaNoNumerosa]" ) {
		...
		Actividad * act2 = new Reconocimiento("Deportes", 2, "Campeonatos universitarios");
		Estudiante * est1 = new Estudiante("peperez",false);
		Matricula * m1 = new Matricula(act1, est1, C1920,M2,20);
		Matricula * m2 = new Matricula(act2, est1, C2122,M2,10);
...
Actividad * act1 = new Asignatura("POO", 6, 2010, Troncal);
		Actividad * act2 = new Reconocimiento("Deportes", 2, "Campeonatos universitarios");
		Estudiante * est1 = new Estudiante("peperez",false);
		Matricula * m1 = new Matricula(act1, est1, C1920,M3,20);
		Matricula  * m2 = new Matricula(act2, est1, C2122,M3,10);
...
Actividad * act1 = new Asignatura("POO", 6, 2010, Troncal);
		Actividad * act2 = new Reconocimiento("Deportes", 2, "Campeonatos universitarios");
		Estudiante * est1 = new Estudiante("peperez",false);
		Matricula * m1 = new Matricula(act1, est1, C1920,M4,20);
		Matricula * m2 = new Matricula(act2, est1, C2122,M4,10);
...
Actividad * act1 = new Asignatura("POO", 6, 2010, Troncal);
		...
		Matricula * m1 = new Matricula(act1, est1, C1920,M1,20);
		Matricula * m2 = new Matricula(act2, est1, C2122,M2,10);
		Matricula * m3 = new Matricula(act3, est1, C1920,M3,20);
		Matricula * m4 = new Matricula(act4, est1, C2122,M4,10);
...
TEST_CASE("Creacion Matricula", "[testMatriculaCreacion]" ) {
        ...
        Actividad * act1 = new Asignatura("POO", 6, 2010, Troncal);
		Estudiante * est1 = new Estudiante("peperez",false);
		Matricula * m1 = new Matricula(act1, est1, C1920,M3,21.21);
...
TEST_CASE("Aprobados Suspenso", "[testAprobadoSuspenso]" ) {
		...
		Matricula *  m2 = new Matricula(act1, est1, C1920,M3,21.21);
		...
		Matricula *  m3 = new Matricula(act1, est1, C1920,M3,21.21);
